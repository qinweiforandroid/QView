...
public class MeiZuMonthView extends MonthView {
    ...
    public MeiZuMonthView(Context context) {
        ...
        mUnSelectedPaint.setColor(Color.YELLOW);
        mUnSelectedPaint.setStyle(Paint.Style.STROKE);
        mUnSelectedPaint.setStrokeWidth(dipToPx(getContext(), 2));
...
//        mSchemeBasicPaint.setMaskFilter(new BlurMaskFilter(25, BlurMaskFilter.Blur.SOLID));
    ...
    protected void onDrawText(Canvas canvas, Calendar calendar, int x, int y, boolean hasScheme, boolean isSelected) {
        ...
        if (isSelected) {
            ...
            //draw 背景
            canvas.drawRect(x + mPadding, y + mPadding, x + mItemWidth - mPadding, y + mItemHeight - mPadding, mUnSelectedPaint);
            canvas.drawText(String.valueOf(calendar.getDay()), cx, mTextBaseLine + top,
